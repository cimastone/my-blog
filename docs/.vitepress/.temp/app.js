...
const siteData = deserializeFunctions(JSON.parse(`{"lang":"en-US","dir":"ltr","title":"CimaStone's Blog","description":"基于 Docker 的个人博客","base":"/blog/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"首页","link":"/guide/"},{"text":"Redisson分布式锁+本地缓存的典型流程","link":"/guide/redisson-distributed-lock"},{"text":"团队研发流程管理 - scrum","link":"/guide/scrum_running"},{"text":"搭建个人博客（vitePress）","link":"/guide/vitePress_blog"},{"text":"高并发查询场景下基于Zookeeper+Redis的分布式一致性缓存设计方案","link":"/guide/zk_redisson_distributed_lock"}],"sidebar":[{"text":"首页","link":"/guide/"},{"text":"技术架构","collapsed":false,"items":[{"text":"分布式缓存","collapsed":false,"items":[{"text":"Redisson分布式锁+本地缓存的典型流程","link":"/guide/redisson-distributed-lock"}]},{"text":"分布式系统","collapsed":false,"items":[{"text":"高并发查询场景下基于Zookeeper+Redis的分布式一致性缓存设计方案","link":"/guide/zk_redisson_distributed_lock"}]}]},{"text":"项目管理","collapsed":false,"items":[{"text":"团队研发流程管理 - scrum","link":"/guide/scrum_running"}]},{"text":"工具教程","collapsed":false,"items":[{"text":"搭建个人博客（vitePress）","link":"/guide/vitePress_blog"},{"text":"Markdown基础语法","link":"/guide/markdown基础语法"}]}]},"locales":{},"scrollOffset":134,"cleanUrls":false}`));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    function renderGiscus() {
      ...
      script.setAttribute("data-repo", "cimastone/giscus_discussion");
      script.setAttribute("data-repo-id", "R_kgDOPF8x1A");
      script.setAttribute("data-category", "General");
      script.setAttribute("data-category-id", "DIC_kwDOPF8x1M4CsZmh");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "giscus_container" }, _attrs))}></div>`);
    };
  }
};

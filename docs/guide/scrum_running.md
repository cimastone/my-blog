...
## 🎯 背景
自2021年接手团队即采取了scrum团队协作方式，根据团队业务属性及人员情况做了相应的本土化调整，形成了一套研发团队运行的机制


## 🎯 团队的基本信息
> 理想的scrum成员配置（3个开发，一个产品，一个测试），目前团队情况6名后端开发人员，2个产品，3个测试；所以我把它拆成了2个scrum团队；每个scrum team由三名开发、一名产品和一名测试组成；再有一位测试负责人，做协调和补位；每个scrum team有一名scrum master
...
这么安排的主要原因：
> - 所负责的业务模块较多，按领域边界划分了两大类，交由两个小组负责
> - 用两个组做A/B测试，过程中相互借鉴，同时探索影响流程落地结果的变量
...
需求文档一般在上个sprint结束前3～4个工作日发在团队群中，提前与scrum master沟通对齐，防止需求认识出现太大分歧
scrum master根据需求文档列出大致的改动点，提前与团队成员进行沟通

按官方所述，需求评审的时间应该在sprint开始之后，但我们没有这样，主要的原因是团队涉及系统较多、业务复杂度较高和业务需求不稳定性较强，就把sprint的开始时间定为需求评审后，用户故事点数规划会那天开始（大概率是同一天）

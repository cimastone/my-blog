...
| Other Income | 不属于主营业务的收入/费用 | 一次性的&&也可以是经常性的 |
| Income Before Tax | 税前利润 | 综合利润 |
| Income Tax | 所得税 | 税率变化要注意 |
| Net Income | 净利润 | 最终利润（但不最“干净”） |
| EPS | 每股收益（净利润/加权平均股本-basic） | 投资常用 |

> 加权评估股本-basic的计算逻辑 = 时间加权平均股本，而不是简单平均
>  - 例子1:
>    - 1月–6月：100股
>    - 7月–12月：120股
>    - Basic shares = 100 × 6/12 + 120 × 6/12 = 110
>  - 例子2:
>    - 1月-11月：100股
>    - 12月：120股
>    - Basic shares = 100×11/12 + 120×1/12 = 101.7
---
...
### 2）Interest Income && Interest Expense && Other Income && AOCI 定义，不同公司场景的联动

| 项目               | 是否发生 | 是否实现      | 是否进利润表 |
| ---------------- | ---- | --------- | ------ |
| Interest Income  | ✔️   | ✔️        | ✔️     |
| Interest Expense | ✔️   | ✔️        | ✔️     |
| Other Income     | ✔️   | ✔️（通常）    | ✔️     |
| AOCI             | ✔️   | ❌（或不进P&L） | ❌      |
...
| 类型      | 存款              | 理财（固定收益）                | 股票           |
| ------- | --------------- | ----------------------- | ------------ |
| 收益来源    | 利息              | 利息/票息                   | 价格波动 + 分红    |
| 是否波动    | ❌               | ⚠️ 小幅                   | ✔️ 大         |
| 是否有AOCI | ❌               | ✔️（可能）                  | ✔️（取决分类）     |
| 利润表科目   | Interest Income | Interest Income / Other | Other Income |
...
🟡 股东权益
  - Accumulated Other Comprehensive Income：+10万
